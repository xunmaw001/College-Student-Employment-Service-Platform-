<template>
  <div class="main-content">
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign" 
               :header-align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('zhaopinxinxi','投掷简历') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="touzhixinxiCrossAddOrUpdateHandler(scope.row,'cross','是','[1]','已投掷简历')">{{ contents.tableBtnFont == 1?'投掷简历':'' }}</el-button>
                <el-button v-if="isAuth('zhaopinxinxi','投掷简历') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="touzhixinxiCrossAddOrUpdateHandler(scope.row,'cross','是','[1]','已投掷简历')">{{ contents.tableBtnFont == 1?'投掷简历':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('zhaopinxinxi','投掷简历') && contents.tableBtnIcon == 0" type="success" size="mini" @click="touzhixinxiCrossAddOrUpdateHandler(scope.row,'cross','是','[1]','已投掷简历')">{{ contents.tableBtnFont == 1?'投掷简历':'' }}</el-button>
    ...
    <touzhixinxi-cross-add-or-update v-if="touzhixinxiCrossAddOrUpdateFlag" :parent="this" ref="touzhixinxiCrossaddOrUpdate"></touzhixinxi-cross-add-or-update>
