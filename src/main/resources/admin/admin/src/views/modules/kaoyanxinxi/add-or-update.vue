<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.zhengmingwenjian" label="证明文件" prop="zhengmingwenjian">
          <file-upload
          tip="点击上传证明文件"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zhengmingwenjian" label="证明文件" prop="zhengmingwenjian">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.zhengmingwenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
