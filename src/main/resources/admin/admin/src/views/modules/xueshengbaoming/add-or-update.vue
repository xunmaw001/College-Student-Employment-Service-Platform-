<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="参加人数" prop="canjiarenshu">
          <el-select :disabled="ro.canjiarenshu" v-model="ruleForm.canjiarenshu" placeholder="请选择参加人数">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="举办时间" prop="jubanshijian">
          <el-input v-model="ruleForm.jubanshijian" 
              placeholder="举办时间" clearable  :readonly="ro.jubanshijian"></el-input>
        </el-form-item>
        <div v-else>
