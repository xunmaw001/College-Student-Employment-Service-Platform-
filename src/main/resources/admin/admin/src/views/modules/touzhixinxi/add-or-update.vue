<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="投掷时间" prop="touzhishijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.touzhishijian" 
                type="datetime"
                :readonly="ro.touzhishijian"
                placeholder="投掷时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.touzhishijian" label="投掷时间" prop="touzhishijian">
              <el-input v-model="ruleForm.touzhishijian" 
                placeholder="投掷时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.touzhishijian = this.getCurDateTime()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jianli = true;
          ...
          if(o=='touzhishijian'){
            this.ruleForm.touzhishijian = obj[o];
	    this.ro.touzhishijian = true;
            continue;
          }
          if(o=='crossuserid'){
